              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                ...
                <li class="user-name"><span>{{ Auth::user()->name }}</span></li>
                  ...
                  <li class="dropdown avatar-dropdown">
                   <img src="{{ url('css2/asset/img/avatar.jpg') }}" class="img-circle avatar" alt="user name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"/>
                ...
                <ul class="nav nav-list">
                    ...
                    <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa-diamond fa"></span> Modul
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                        <li><a href="{{ url('admin/newsadd') }}">News</a></li>
                        <li><a href="{{ url('admin/masteradd') }}">Master</a></li>
                      </ul>
                    </li>
                     <li class="ripple">
                      <a class="tree-toggle nav-header">
                        <span class="fa-diamond fa"></span> Admin
                        <span class="fa-angle-right fa right-arrow text-right"></span>
                      </a>
                      <ul class="nav nav-list tree">
                        <li><a href="{{url ('/register') }}">Add New Admin</a></li>
                      </ul>
                    </li>
                </ul>
                </div>
